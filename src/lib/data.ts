...
export const products: Product[] = [
  // Office Category (3 products, 1 on sale)
  {
    ...
    onSale: true,
    images: [
      "https://images.unsplash.com/photo-1534353436294-0dbd4bdac845?w=800&auto=format&fit=crop&q=80", // Minimalist desk lamp
      "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'office',
  ...
  },
  {
    ...
    price: 299.99,
    images: [
      "https://images.unsplash.com/photo-1580480055273-228ff5388ef8?w=800&auto=format&fit=crop&q=80", // Ergonomic office chair
      "https://images.unsplash.com/photo-1505843513577-22bb7d21e455?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'office',
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1544816155-12df9643f363?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'office',
  ...
  // Furniture Category (3 products, 1 on sale)
  {
    ...
    onSale: true,
    images: [
      "https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?w=800&auto=format&fit=crop&q=80", // Scandinavian coffee table
      "https://images.unsplash.com/photo-1581428982868-e410dd047a90?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'furniture',
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1611269154421-4e27233ac5c7?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'furniture',
  ...
  },
  {
    ...
    price: 349.99,
    images: [
      "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&auto=format&fit=crop&q=80", // Mid-century armchair
      "https://images.unsplash.com/photo-1550226891-ef816aed4a98?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'furniture',
  ...
  // Lighting Category (4 products, 1 on sale)
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1519710164239-da123dc03ef4?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'lighting',
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1540932568230-11b5c6d396e5?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'lighting',
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1572635196243-4dd75fbdbd7f?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'lighting',
  ...
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1615874959474-d609969a20ed?w=800&auto=format&fit=crop&q=80"  // Another angle
    ],
    category: 'lighting',
